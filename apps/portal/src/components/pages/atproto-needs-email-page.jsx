        ...
        <div>
          ...
          <div className="gh-portal-atproto-needs-email">
            ...
            <p>
              <Interpolate
                string={t(
                  'A confirmation link has been sent to {email}. Click it to complete your sign up.',
                )}
                mapping={{
    ...
    return (
      <div>
        ...
        <div className="gh-portal-atproto-needs-email">
          ...
          <p>
            {t(
              "Your Bluesky account doesn't have a verified email. Please enter an email address to complete your sign up.",
            )}
          </p>
          ...
          <form onSubmit={this.handleSubmit}>
            <input
              ...
              autoFocus
            />
            {errors.email && <p className="gh-portal-input-error">{errors.email}</p>}

            <ActionButton onClick={this.handleSubmit} disabled={isLoading} isLoading={isLoading}>
